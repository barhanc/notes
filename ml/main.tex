...
\[
\begin{split}
&\bm{\bar{X}} := \pdv{\eLL}{\bm{X}}\\
&\bm{\bar{F}}\at{i_1,..,i_n} = \sum_{\bm{S} \in \text{succ}(\bm{F})} \sum_{j_1,..,j_m} \bm{\bar{S}}\at{j_1,..,j_m} \pdv{\bm{S}\at{j_1,..,j_m}}{\bm{F}\at{i_1,..,i_n}}\\
&\bm{\bar{W}}\at{i_1,..,i_n} = \sum_{j_1,..,j_m} \bm{\bar{F}}\at{j_1,..,j_m} \pdv{\bm{F}\at{j_1,..,j_m}}{\bm{W}\at{i_1,..,i_n}} 
\end{split}
\]
