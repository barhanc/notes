...
\end{equation*}
Całkę w powyższym wzorze nazywa się również funkcją ryzyka (z ang. \textit{risk function}) \(R(\hat{\theta})\), która określa oczekiwaną stratę spowodowaną wykorzystaniem danego estymatora parametru \(\theta\). W przypadku gdy funkcja kosztu ma postać błędu kwadratowego (L2)
\begin{equation*}
