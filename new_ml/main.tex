...
\end{equation*}
Wartość oczekiwana statystyki średniej \(\overline{X}(X_1, \ldots, X_n)\) dla \(X_i\) z rozkładu \(X \sim \mathcal{D}\) o gęstości \(p\) wynosi
\begin{equation*}
...
W jaki sposób mamy wybrać rozkład proponujący kandydatów \(q\)? Pewną odpowiedź na to pytanie sugeruje analiza wariancji statystyki 
\begin{equation*}
