...
oraz
\begin{equation*}
    \braket{\oper{\mathcal{A}}\Psi}{\oper{\mathcal{B}}\Psi} + \braket{\oper{\mathcal{B}}\Psi}{\oper{\mathcal{A}}\Psi} = \bra{\Psi}\{\oper{\mathcal{A}},\oper{\mathcal{B}}\}\ket{\Psi} = \bra{\Psi}\{\oper{A},\oper{B}\} - 2\expval{A}\expval{B}
\end{equation*}
...
operatorów. Istotnie różniczkując operator rzutowy \(\oper{\rho} = \ket{\Psi}\bra{\Psi}\) mamy
\begin{equation*}
    \begin{split}
