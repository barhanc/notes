...
% TODO
% general solution of SE for time-independent hamiltonian
% separation of variables approach
% simple perturbation theory for finite-dimensional Hilbert space
% my idea on propagators 
% ------
% Pauli representation of hermitian operator (WLOG assume a0 = 0, why?)
% Bloch sphere and some projective/inversion theorems
% ------
% general solution for time-independent H for two-state system
% application of perturbation theory and propagators
