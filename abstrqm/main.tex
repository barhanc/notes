...
% * Add solved examples precession (constant H), general (?)
%
...
\begin{equation*}
    \begin{split}
        &\alpha(t) = \frac{\im\omega_0B_\text{rf}}{\Omega B_0}\e^{+\im\omega t/2}\\
...
ale nie obdarzoną ładunkiem elektrycznym, która została umieszczona w stałym w czasie i jednorodnym
polu magnetycznym \(\mathbf{B}\).
