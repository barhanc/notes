...
% general solution of SE for time-independent hamiltonian exp(-iHt)
%
% separation of variables approach + simple perturbation theory for finite-dimensional Hilbert space
% (n-state systems)
%
% my idea on propagators 
%
% ------ 2-STATE SYS
%
% def. self-adjoint == hermitian operator (matrix)
%
% Pauli representation of hermitian operator (WLOG assume r0 = 0, why?)
%
% Bloch sphere and some projective/inversion theorems
%
% general solution for time-independent H for two-state system: cos |r| - i sin|r|
%
