...
lub półmetryki) sąsiadów (z ang. \textit{nearest neoghbours}) dla danego nowego punktu. Zasadniczą
ideą tych metod jest iż punkty leżące blisko siebie w pewnej przestrzneni powinny mieć podobne
własności, czyli taka przestrzeń metryczna powinna być \textit{semantycznie sensowna}.

Jednym z najprostszych algorytmów z tej dziedziny jest \textit{k-nearest neighbours} (kNN) używany
...
prawdopodobieńśtwa nad możliwymi klasami jako stosunek liczby punktów z daną klasą do liczby
...
metody aproksymacyjne (z ang. \textit{Approximate Nearest Neighbours}). W algorytmach
