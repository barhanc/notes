...
\subsection{Selekcja cech i redukcja wymiarowości}
...
Najczęstszymi podejściami do selekcji cech są tzw. metody \textit{filter}, \textit{embedded} i
\textit{wrapper}.
\begin{itemize}
    ...
    \item \textbf{Metody \textit{embedded}}.

    \item \textbf{Metody \textit{wrapper}}.
\end{itemize}
