...
nie generalizują się dobrze poza zbiór treningowy. Bardzo ważnym elementem budowy sieci neurownowych
...
\begin{enumerate}
    ...
    Innym prostym, lecz efektywnympodejściem do regularyzacji sieci neuronowych jest procedura
    ...
    może być równy \(0\) z p-stwem \(p\) lub 1 z p-stwem \(1-p\)). Mechanizmu dropoutu używamy tylko
    ...
    % TODO: Initialization, Winning Tickets
