...
get mixed and are no longer i.i.d. Additionaly the layer behaves differently during training and
...
\begin{split}
   \pdv{F_{\alpha'\alpha}}{X_{\beta'\beta}} = A_\alpha \bigg[ 
                                              ...
                                              & - (S_\alpha + \epsilon)^{-\onehalf} \pdv{M_\alpha}{X_{\beta'\beta}}  \bigg]\quad.
\end{split}
\]
...
\begin{split}
   \pdv{L}{X_{\beta'\beta}} = &\sum_{\alpha'\alpha} \pdv{L}{F_{\alpha'\alpha}} \pdv{F_{\alpha'\alpha}}{X_{\beta'\beta}} \\
                            = &A_\beta(S_\beta + \epsilon)^{-\onehalf} \pdv{L}{F_{\beta'\beta}} \\
                            & - \frac{1}{n}(S_\beta + \epsilon)^{-\threehalves} (X_{\beta'\beta} - M_{\beta}) \sum_{\alpha'} \pdv{L}{F_{\alpha'\beta}} (X_{\alpha'\beta} - M_\beta) \\
                            & - \frac{1}{n} (S_\beta + \epsilon)^{-\onehalf} \sum_{\alpha'} \pdv{L}{F_{\alpha'\beta}}
\end{split}
\]
Denoting \(\hat{X}_{\alpha'\alpha} = (X_{\alpha'\alpha} - M_\alpha) / \sqrt{S_\alpha + \epsilon}\)
we can write this expression in a more elegant form
\[
\boxed
{
\begin{split}
